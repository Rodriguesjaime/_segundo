...
<section >
<h1 id="reg"> Cadastro de docente</h1>
<hr><br>

</p>
<form id="fomu1" method="post" action="processo_doc.php">
...
?> 
    ...
    <p id="parag">
        Nome<br><input type="text" name="nomed" id="cnome" size="30" maxlength="30" placeholder="nome complento"/><br>
        Apelido<br><input type="text" name="apelid" id="cnome" size="30" maxlength="30" placeholder="Apelido"><br>
        ...
        BI<br><input type="text" name="bid" id="cnome" size="30" maxlength="15" placeholder="Digite 14 digitos e uma letra"><br>
        Usuario <br><input type="text" name="usuario" id="cnome" size="30" maxlength="15" placeholder="introduz o nome do usuario"/><br>
         Senha<br><input type="password" name="senhad" id="cnome" size="30" maxlength="10" placeholder="senha ou password"/><br>
         Especializacao<br><input type="text" name="espec" id="cnome" size="30" maxlength="30" placeholder="Especializacao"><br> 
