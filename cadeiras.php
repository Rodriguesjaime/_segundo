...
<section >
<h1 id="reg"> Cadastro de cadeiras</h1>
<hr><br>

</p>
<form id="fomu1" method="post" action="processo_cad.php">
...
<br><br><br>
    <p id="parag">
        Nome:<br><input type="text" name="cnome" id="cnome" size="30" maxlength="30" placeholder="nome da cadeira"/><br>
